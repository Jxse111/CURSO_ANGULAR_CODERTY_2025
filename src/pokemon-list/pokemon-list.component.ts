...
export class PokemonListComponent {
  public pokemons = [
    ...
    { name: "Metagross", src: "https://db.pokemongohub.net/_next/image?url=%2Fimages%2Fofficial%2Ffull%2F376.webp&w=640&q=75", skills: "[Puño Meteoro,Psíquico]", types: "[Acero, Psíquico]" },
